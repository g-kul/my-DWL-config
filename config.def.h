...
static const int showsystray = 1;             /* 0 meaff5555systray */
...
static uint32_t colors[][3] = {
    /*               fg          bg          border    */
    [SchemeNorm] = {0x7aa2f7ff, 0x1a1b26ff, 0x504945ff},
    [SchemeSel] = {0xc0caf5ff, 0x1a1b26ff, 0xc0caf5ff},
    [SchemeUrg] = {0xc0caf5ff, 0x283457, 0xff5555ff},
};
/* tagging */
...
static const char *const autostart[] = {
    "swaybg", "-i",   "/home/gokul/Pictures/wallpaper/wallpaper.png",
    NULL,     "mako", NULL,
    "copyq",  NULL,   NULL /* terminate */
};
...
static const char *menucmd[] = {"wmenu-run", "-f", "Terminess Nerd Font 14",
                                NULL};
static const char *dmenucmd[] = {"wmenu", NULL};
static const char *screenshotcmd[] = {
    "sh", "-c", "grim -g \"$(slurp -d)\" - | wl-copy", NULL};
static const Key keys[] = {
    ...
    {0,
     ...
     spawn,
     {.v = (const char *[]){"brightnessctl", "set", "5%+", NULL}}},
    {0,
